...
DATASET_BINDINGS: tuple[DatasetBinding, ...] = (
    DatasetBinding(
        ...
        projections=(
            ...
            ProjectionColumn(
                "league", "LEAGUE", "api.v_canonical_player_season_totals.LEAGUE"
            ),
            ...
            ProjectionColumn(
                "total_rebounds_per_game", "TRB / G", None, "per_game_rate"
            ),
    ...
    DatasetBinding(
        ...
        projections=(
            ProjectionColumn(
                "season_end_year",
                "season_year normalized to ending year",
                None,
                "season_end_year",
            ),
            ProjectionColumn(
                "season",
                "season_year",
                "unified_star.fact_player_season_stats.season_year",
            ),
            ProjectionColumn(
                "team", "team_abbrev", "unified_star.dim_team.team_abbrev"
            ),
            ...
            ProjectionColumn(
                "vorp", "vorp", "unified_star.fact_player_season_stats.vorp"
            ),
            ProjectionColumn(
                "ts_pct", "ts_pct", "unified_star.fact_player_season_stats.ts_pct"
            ),
            ProjectionColumn(
                "usg_pct", "usg_pct", "unified_star.fact_player_season_stats.usg_pct"
            ),
        ),
        default_order_by=("season_end_year DESC", "team"),
        max_page_size=500,
    ...
    DatasetBinding(
        ...
        projections=(
            ProjectionColumn(
                "full_name", "full_name", "unified_star.dim_player.full_name"
            ),
            ProjectionColumn(
                "bref_player_id",
                "bref_player_id",
                "unified_star.dim_player.bref_player_id",
            ),
            ProjectionColumn(
                "season_end_year",
                "season_year normalized to ending year",
