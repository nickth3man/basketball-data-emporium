...
ROWS = [
    (
        "curry_2016_3pm", "player_season", "curryst01", 2016, False, 1610612744,
        "3P", 402,
        "SELECT \"3P\" FROM api.v_canonical_player_season_totals "
        "WHERE PLAYER_ID = 'curryst01' AND SEASON = 2016 AND TEAM_ABBR = 'GSW'",
        "anchor_html", "player_career_stats/curryst01.html",
        "https://www.basketball-reference.com/players/c/curryst01.html", "",
    ),
    (
        "curry_2016_pts", "player_season", "curryst01", 2016, False, 1610612744,
        "PTS", 2375,
    ...
    (
        "jordan_1987_pts", "player_season", "jordami01", 1987, False, 0,
        "PTS", 3041,
        ...
        "anchor_html", "player_career_stats/jordami01.html",
        "https://www.basketball-reference.com/players/j/jordami01.html", "",
    ),
    (
        "wilt_1962_pts", "player_season", "chambwi01", 1962, False, 0,
        "PTS", 4029,
        "SELECT s.pts FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
        ...
        "anchor_html", "player_career_stats/chambwi01.html",
        "https://www.basketball-reference.com/players/c/chambwi01.html",
        "pre_1973_anchor_stl_blk_also_asserted_null",
    ),
    (
        "wilt_1962_stl_null", "player_season", "chambwi01", 1962, False, 0,
        "STL", None,
    ...
    (
        "wilt_1962_blk_null", "player_season", "chambwi01", 1962, False, 0,
        "BLK", None,
    ...
    (
        "kobe_81_game", "game_boxscore", "bryanko01", 2006, False, 1610612747,
        "PTS", 81,
        ...
        "anchor_html", "team_box_scores/2006_01_22/200601220LAL.html",
        "https://www.basketball-reference.com/boxscores/200601220LAL.html", "",
    ),
    (
        "wilt_100_game", "game_boxscore", "chambwi01", 1962, False, 0,
        "PTS", 100,
        "SELECT DISTINCT b.points FROM unified_star.fact_player_game_boxscore b "
        "JOIN api.v_game_summary g ON b.game_id = g.game_id "
        "WHERE b.player_id = (SELECT player_id FROM unified_star.dim_player "
    ...
    (
        "wilt_100_game_stl_zero", "game_boxscore", "chambwi01", 1962, False, 0,
        "STL", 0,
    ...
    (
        "wilt_100_game_blk_zero", "game_boxscore", "chambwi01", 1962, False, 0,
        "BLK", 0,
    ...
    (
        ...
        "anchor_html", "player_career_stats/abdulka01.html",
        "https://www.basketball-reference.com/players/a/abdulka01.html", "",
    ),
    (
        "wilt_career_pts", "player_career", "chambwi01", "", "", 0,
        "PTS", 31419,
        "SELECT SUM(s.pts) FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
        "        WHERE bref_player_id = 'chambwi01') "
    ...
    (
        "jordan_career_pts", "player_career", "jordami01", "", "", 0,
        "PTS", 32292,
        "SELECT SUM(s.pts) FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
        "        WHERE bref_player_id = 'jordami01') "
    ...
    (
        "lebron_2024_pts", "player_season", "jamesle01", 2024, False, 1610612747,
        "PTS", 1822,
        "SELECT s.pts FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
        ...
        "anchor_html", "player_career_stats/jamesle01.html",
        "https://www.basketball-reference.com/players/j/jamesle01.html",
        "settled_2023_24_season",
    ),
    (
        "lebron_2024_po_pts", "player_season", "jamesle01", 2024, True, 1610612747,
        "PTS", 139,
        "SELECT s.pts FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
        "        WHERE bref_player_id = 'jamesle01') "
    ...
    (
        "tatum_2024_reg_pts", "player_season", "tatumja01", 2024, False, 1610612738,
        "PTS", 1987,
        "SELECT s.pts FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
        ...
        "anchor_html", "player_career_stats/tatumja01.html",
        "https://www.basketball-reference.com/players/t/tatumja01.html",
        "settled_2023_24_season",
    ),
    (
        "tatum_2024_po_pts", "player_season", "tatumja01", 2024, True, 1610612738,
        "PTS", 475,
        "SELECT s.pts FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
        "        WHERE bref_player_id = 'tatumja01') "
    ...
    (
        "luka_2024_pts_leader", "player_season", "doncilu01", 2024, False, 1610612742,
        "PTS", 2370,
        "SELECT s.pts FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
    ...
    (
        "jokic_2024_per", "player_season", "jokicni01", 2024, False, 1610612743,
        "PER", 31.0,
        ...
        "anchor_html", "players_advanced_season_totals/2024_false.html",
        "https://www.basketball-reference.com/leagues/NBA_2024_advanced.html",
        "advanced_leader_2023_24",
    ),
    (
        "jokic_2024_bpm", "player_season", "jokicni01", 2024, False, 1610612743,
        "BPM", 13.2,
    ...
    (
        "harden_2022_brk_pts", "player_season", "hardeja01", 2022, False, 1610612751,
        "PTS", 990,
        "SELECT s.pts FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
    ...
    (
        "harden_2022_phi_pts", "player_season", "hardeja01", 2022, False, 1610612755,
        "PTS", 442,
        "SELECT s.pts FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
        "        WHERE bref_player_id = 'hardeja01') "
    ...
    (
        "harden_2022_combined_check", "player_season", "hardeja01", 2022, False, 0,
        "PTS", 1432,
    ...
    (
        "lebron_career_pts", "player_career", "jamesle01", "", "", 0,
        "PTS", 43440,
        "SELECT SUM(s.pts) FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
        "        WHERE bref_player_id = 'jamesle01') "
    ...
    (
        "curry_career_3pm", "player_career", "curryst01", "", "", 0,
        "3P", 4248,
    ...
    (
        "bird_career_pts", "player_career", "birdla01", "", "", 0,
        "PTS", 21791,
        "SELECT SUM(s.pts) FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
        "        WHERE bref_player_id = 'birdla01') "
        "  AND s.season_year LIKE '%-%' AND s.is_playoffs = false",
        "anchor_html", "player_career_stats/birdla01.html",
        "https://www.basketball-reference.com/players/b/birdla01.html", "",
    ),
    (
        "duncan_career_pts", "player_career", "duncati01", "", "", 0,
        "PTS", 26496,
        "SELECT SUM(s.pts) FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
    ...
    (
        "russell_career_pts", "player_career", "russebi01", "", "", 0,
        "PTS", 14522,
        "SELECT SUM(s.pts) FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
        "        WHERE bref_player_id = 'russebi01') "
        "  AND s.season_year LIKE '%-%' AND s.is_playoffs = false",
        "anchor_html", "player_career_stats/russebi01.html",
        "https://www.basketball-reference.com/players/r/russebi01.html",
        "pre_1973_stl_and_blk_also_asserted_null",
    ),
    (
        "russell_career_stl_null", "player_career", "russebi01", "", "", 0,
        "STL", None,
        "SELECT SUM(s.stl) FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
        "        WHERE bref_player_id = 'russebi01') "
    ...
    (
        "russell_career_blk_null", "player_career", "russebi01", "", "", 0,
        "BLK", None,
    ...
    (
        "paul_career_ast", "player_career", "paulch01", "", "", 0,
        "AST", 12552,
        "SELECT SUM(s.ast) FROM unified_star.fact_player_season_stats s "
        "WHERE s.player_id = (SELECT player_id FROM unified_star.dim_player "
    ...
    (
        "lal_franchise_pts_leader", "franchise_leaders", "LAL", "", "", 1610612747,
        "PTS", 33643,
        ...
        ")",
        "anchor_html", "franchise_career_leaders/LAL_career_leaders.html",
    ...
    (
        "bos_franchise_pts_leader", "franchise_leaders", "BOS", "", "", 1610612738,
        "PTS", 26395,
        "SELECT MAX(reg_pts) FROM ("
        "  SELECT s.player_id, SUM(s.pts) AS reg_pts "
        "  FROM unified_star.fact_player_season_stats s "
        ...
        "  GROUP BY s.player_id"
        ")",
        "anchor_html", "franchise_career_leaders/BOS_career_leaders.html",
...
COLUMNS = [
    "golden_id", "entity_type", "identifier", "season_end_year", "is_playoffs",
    "team_id", "stat_key", "expected_value", "sql_query", "source_type",
    "anchor_path", "source_url", "caveat",
]
